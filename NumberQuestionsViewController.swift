...
class NumberQuestionsViewController: UIViewController {
    ...
    func prepareView()
    {
        ...
        button10.setTitle("10", for: UIControlState())
        button10.setTitleColor(Color.black, for: UIControlState())
        ...
        button10.addTarget(self, action:  #selector(handleButton10), for: .touchUpInside)
        ...
        button20.setTitle("20", for: UIControlState())
        button20.setTitleColor(Color.black, for: UIControlState())
        ...
        button20.addTarget(self, action:  #selector(handleButton20), for: .touchUpInside)
        ...
        button30.setTitle("30", for: UIControlState())
        button30.setTitleColor(Color.black, for: UIControlState())
        ...
        button30.addTarget(self, action:  #selector(handleButton30), for: .touchUpInside)
        ...
        button50.setTitle("50", for: UIControlState())
        button50.setTitleColor(Color.black, for: UIControlState())
        ...
        button50.addTarget(self, action:  #selector(handleButton50), for: .touchUpInside)
        ...
        button100.setTitle("100", for: UIControlState())
        button100.setTitleColor(Color.black, for: UIControlState())
        ...
        button100.addTarget(self, action:  #selector(handleButton100), for: .touchUpInside)
        ...
        buttonUnlimited.setTitle("150", for: UIControlState())
        buttonUnlimited.setTitleColor(Color.black, for: UIControlState())
        ...
        buttonUnlimited.addTarget(self, action:  #selector(handleButtonunlimited), for: .touchUpInside)
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        UIImageView.animate(withDuration: 2.5, animations: {
